...
const INITIAL_DIVISIONS = [
  { id: "1", name: "Commercial", head: "John Rutherford", projects: 5 },
  { id: "2", name: "Healthcare", head: "Sarah Mitchell", projects: 3 },
  { id: "3", name: "Mixed-Use", head: "David Chen", projects: 2 },
];
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="mb-6 flex gap-2">
            ...
            />
            <Button onClick={handleAdd}><Plus className="mr-1.5 h-4 w-4" /> Add Division</Button>
          </div>
